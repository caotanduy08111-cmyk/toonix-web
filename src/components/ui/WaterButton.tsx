...
export default function MetallicButton(props: Record<string, unknown>) {
  return <__OriginkitBase_MetallicButton {...(__originkitPresetProps as Record<string, unknown>)} {...props} />;
}
