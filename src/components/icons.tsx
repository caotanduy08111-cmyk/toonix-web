...
export function HeartIcon({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <path d="M12 20.3c-.3 0-.5-.1-.7-.3C7.9 17.4 3 13.3 3 9c0-3 2.3-5.3 5.2-5.3 1.6 0 3.1.8 3.8 2 .7-1.2 2.2-2 3.8-2C18.7 3.7 21 6 21 9c0 4.3-4.9 8.4-8.3 11-.2.2-.4.3-.7.3z" />
    </svg>
  );
}
